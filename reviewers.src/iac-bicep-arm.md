...
id: iac-bicep-arm
type: primary
focus: Detect Bicep and ARM template misconfigurations including hardcoded secrets, missing parameter
  defaults and validation, unversioned Bicep modules, missing resource locks, and deployment mode risks
parents:
- index.md
covers:
