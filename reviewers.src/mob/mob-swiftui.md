...
id: mob-swiftui
type: primary
focus: Detect SwiftUI lifecycle mismanagement with @State/@Binding, overly complex view bodies, missing
  onDisappear cleanup, NavigationStack misuse, environment object propagation failures, and unbuildable
  previews.
parents:
- index.md
covers:
