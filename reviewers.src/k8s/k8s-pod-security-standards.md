...
type: primary
focus: Detect pods violating Kubernetes Pod Security Standards including running as root, privileged mode,
  missing seccomp profiles, undropped capabilities, and absent PSA namespace labels
parents:
- index.md
aliases:
- cloud-gcp-gke
