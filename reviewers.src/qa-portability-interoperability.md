...
type: primary
focus: Detect OS-specific code without abstraction, hardcoded paths, platform-specific APIs without fallback,
  missing charset/encoding handling, and byte-order assumptions that hinder portability and interoperability
parents:
- index.md
covers:
