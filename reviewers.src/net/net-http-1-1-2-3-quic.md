...
type: primary
focus: Detect HTTP protocol version misuse including HTTP/1.1 without keep-alive, HTTP/2 without TLS,
  missing HTTP/3 fallback, HPACK/QPACK compression attacks, and ALPN negotiation gaps
parents:
- index.md
aliases:
- perf-network-io
