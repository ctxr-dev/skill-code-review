...
type: primary
focus: Detect hypermedia API issues including missing links in responses, hardcoded URLs in clients, non-standard
  media types, missing self links, and incorrect JSON:API or JSON-LD structure
parents:
- index.md
covers:
