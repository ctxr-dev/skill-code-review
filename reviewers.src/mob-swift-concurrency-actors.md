...
type: primary
focus: Detect data races from actor reentrancy, MainActor blocking, uncancelled Tasks, missing Sendable
  conformance, and structured concurrency violations in Swift concurrency.
parents:
- index.md
covers:
