...
type: primary
focus: Detect patterns that defeat tree shaking, bloat bundles, and prevent effective code elimination
  including barrel file re-exports, side-effect-ful modules, and dynamic import misuse.
parents:
- index.md
covers:
