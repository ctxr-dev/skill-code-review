...
type: primary
focus: Detect Jupyter notebook reproducibility hazards -- out-of-order execution, missing kernel spec,
  unset seeds, hardcoded paths, committed outputs, leaked secrets, and absent environment pinning
parents:
- index.md
covers:
