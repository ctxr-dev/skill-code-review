...
id: cicd-circleci
type: primary
focus: Detect CircleCI security and reliability issues including unpinned orbs, secrets in config, missing
  context restrictions, improper parallelism, wrong resource classes, and missing workspace persistence
parents:
- index.md
covers:
