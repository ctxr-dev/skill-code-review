...
type: primary
focus: Detect PII handling violations including collecting more data than needed, PII in logs and caches,
  PII not pseudonymized when possible, PII stored without purpose limitation, and PII shared with third
  parties without controls
parents:
- index.md
covers:
