...
type: primary
focus: Detect distributed SQL pitfalls around clock skew, transaction contention, interleaved tables,
  zone configuration, and the unique performance characteristics of globally distributed ACID databases
parents:
- index.md
covers:
