...
type: primary
focus: Detect DynamoDB design pitfalls including hot partition keys, missing GSIs for access patterns,
  scan-over-query usage, absent TTL on ephemeral data, and capacity mode mismatches
parents:
- index.md
aliases:
