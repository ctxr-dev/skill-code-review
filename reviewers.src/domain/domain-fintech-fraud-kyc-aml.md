...
type: primary
focus: Detect fraud checks ordered after transactions, hardcoded risk thresholds, missing velocity checks,
  KYC gaps before high-risk operations, excessive PII retention, and absent AML screening
parents:
- index.md
covers:
