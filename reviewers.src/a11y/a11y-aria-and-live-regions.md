...
type: primary
focus: Detect incorrect ARIA roles, misuse of aria-hidden on focusable elements, missing aria-live for
  dynamic content, redundant ARIA on native elements, and aria-label without visible label.
parents:
- index.md
aliases:
