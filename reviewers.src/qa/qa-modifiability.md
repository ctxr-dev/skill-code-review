...
id: qa-modifiability
type: primary
focus: Detect change amplification, rigid dependencies, missing extension points, hardcoded policy, and
  insufficient interface segregation that make the codebase resistant to modification
parents:
- index.md
covers:
