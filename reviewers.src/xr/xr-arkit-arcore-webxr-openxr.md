...
type: primary
focus: Detect XR hazards -- missing user gesture for session, absent device fallback, anchor leaks, untracked-quality
  placement, and comfort / privacy omissions in ARKit, ARCore, WebXR, and OpenXR code
parents:
- index.md
covers:
