...
type: primary
focus: Detect push-notification pitfalls across APNs, FCM, and WebPush -- token handling, batching, silent-push
  abuse, payload privacy, and unsubscribe discipline
parents:
- index.md
covers:
