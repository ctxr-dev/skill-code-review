...
id: tool-clippy
type: primary
focus: Detect misconfigured or under-utilized Clippy setups -- unjustified allow attributes, missing CI
  integration, unreviewed pedantic lints, and incomplete target coverage
parents:
- index.md
covers:
