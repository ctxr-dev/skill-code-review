...
type: primary
focus: Detect bounded context boundary violations -- importing another context's internals, shared kernel
  growing unbounded, missing anti-corruption layers, and coupling that erodes context autonomy.
parents:
- index.md
aliases:
- ddd-context-mapping
