...
type: primary
focus: Detect string comparison without Unicode normalization, mixed encoding assumptions, BOM handling
  issues, surrogate pair breakage, and homoglyph attack surfaces
parents:
- index.md
covers:
