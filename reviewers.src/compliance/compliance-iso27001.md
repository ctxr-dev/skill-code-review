...
type: primary
focus: Detect ISO 27001 Annex A control gaps including missing asset classification, absent access control
  policy enforcement, missing backup verification, no secure development lifecycle signals, and information
  leakage channels
parents:
- index.md
covers:
