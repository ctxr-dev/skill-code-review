...
type: primary
focus: Detect lockfile mismanagement across all package managers including uncommitted lockfiles, out-of-sync
  lockfiles, unreviewed lockfile diffs, missing integrity hashes, and improperly resolved merge conflicts
parents:
- index.md
covers:
