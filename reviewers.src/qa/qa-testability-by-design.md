...
type: primary
focus: Detect static method calls preventing mocking, hidden dependencies via service locator or global
  state, non-deterministic behavior, tightly coupled components, missing dependency injection, and side
