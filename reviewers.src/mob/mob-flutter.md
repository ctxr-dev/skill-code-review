...
id: mob-flutter
type: primary
focus: Detect setState in build causing loops, missing dispose() for controllers, large widget trees without
  const, platform channel error handling gaps, and missing error widgets in Flutter.
parents:
- index.md
aliases:
- lang-dart
