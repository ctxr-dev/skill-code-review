...
type: primary
focus: Detect pandas on data too large for memory, missing dtypes with object columns, chained indexing,
  Spark shuffle too wide, missing schema validation on input, and Polars lazy not collected
parents:
- index.md
covers:
