...
type: primary
focus: Detect CLI/TUI ergonomics failures -- missing --help/--version, inconsistent flag naming, broken
  piping, interactive prompts without non-interactive fallback, missing signal handling, and disregard
