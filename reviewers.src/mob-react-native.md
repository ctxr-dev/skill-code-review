...
id: mob-react-native
type: primary
focus: Detect bridge overhead from frequent native calls, large state serialization on the JS thread,
  missing native module error handling, missing Hermes optimization, and navigation memory leaks in React
  Native.
parents:
- index.md
covers:
