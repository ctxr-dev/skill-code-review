...
type: primary
focus: Detect misuse, over-application, and absence of the Flyweight pattern in shared-object memory optimization
  code.
parents:
- index.md
covers:
...
- 'Flyweight optimization is justified by profiling: the shared objects are numerous and their unshared
  allocation would be measurably wasteful'
