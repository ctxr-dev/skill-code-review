...
type: primary
focus: Detect strangler fig migration failures where new functionality bypasses the new system, old system
  is not gradually replaced, feature parity is unchecked, dual-running lacks comparison, rollback is absent,
  or traffic shifting has no metrics
parents:
- index.md
covers:
