...
id: tool-ruff-pylint
type: primary
focus: Detect misconfigured or under-utilized Ruff and Pylint setups -- overly broad per-file-ignores,
  unjustified noqa annotations, conflicting formatter configs, and missing rule categories
parents:
- index.md
covers:
