...
id: iac-terraform
type: primary
focus: Detect Terraform misconfigurations including unpinned module/provider versions, local state backends,
  hardcoded secrets, missing lifecycle guards on stateful resources, and count/for_each misuse
parents:
- index.md
covers:
