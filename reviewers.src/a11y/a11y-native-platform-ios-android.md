...
type: primary
focus: Detect missing accessibilityLabel (iOS), missing contentDescription (Android), custom views without
  accessibility traits, undersized touch targets, unsupported Dynamic Type, and untested VoiceOver/TalkBack
  paths.
parents:
- index.md
covers:
