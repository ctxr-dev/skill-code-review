...
id: orm-drizzle
type: primary
focus: Detect Drizzle ORM pitfalls including type safety gaps in raw SQL, missing prepared statements,
  schema push vs migrate confusion, connection handling, and SQL injection in sql`` template misuse
parents:
- index.md
covers:
