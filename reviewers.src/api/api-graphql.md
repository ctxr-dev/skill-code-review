...
id: api-graphql
type: primary
focus: Detect N+1 resolver queries, unbounded query depth/complexity, overfetching in schema design, missing
  per-field authorization, and introspection enabled in production
parents:
- index.md
covers:
