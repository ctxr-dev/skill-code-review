...
id: iac-crossplane
type: primary
focus: Detect Crossplane misconfigurations including untested compositions, missing providerConfigRef,
  absent deletion policies, XRD validation gaps, claim namespace issues, and non-idempotent patches
parents:
- index.md
covers:
