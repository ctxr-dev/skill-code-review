...
type: primary
focus: Detect XML External Entity injection and XML parser misconfigurations that enable file disclosure,
...
- Go xml.Decoder processing untrusted XML (standard library is safe by default but custom resolvers may
  not be)
