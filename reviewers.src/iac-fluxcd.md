...
id: iac-fluxcd
type: primary
focus: Detect Flux CD misconfigurations including unpinned source references, missing notification providers,
  Kustomization without health checks, absent suspend capability, HelmRelease validation gaps, and aggressive
