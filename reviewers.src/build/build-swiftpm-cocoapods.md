...
type: primary
focus: Detect Swift Package Manager and CocoaPods misconfigurations including uncommitted resolution files,
  unpinned pod versions, missing platform requirements, and large binary dependencies
parents:
- index.md
covers:
