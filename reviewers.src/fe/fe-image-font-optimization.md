...
type: primary
focus: Detect unoptimized images, missing lazy loading, font loading issues (FOIT/FOUT), excessive font
  weights, and missing preload for critical assets that degrade LCP and CLS.
parents:
- index.md
covers:
