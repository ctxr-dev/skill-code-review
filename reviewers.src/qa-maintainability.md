...
type: primary
focus: Detect aggregated maintainability-index signals including high cyclomatic complexity, low cohesion,
  high coupling, missing tests for changed code, magic numbers, long methods, and deep nesting
parents:
- index.md
covers:
