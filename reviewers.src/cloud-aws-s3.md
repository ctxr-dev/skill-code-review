...
id: cloud-aws-s3
type: primary
focus: Detect S3 bucket misconfigurations including public access exposure, missing encryption, permissive
  bucket policies, absent versioning, and overly broad CORS rules
parents:
- index.md
covers:
