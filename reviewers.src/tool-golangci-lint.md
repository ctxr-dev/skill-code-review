...
type: primary
focus: Detect misconfigured or under-utilized golangci-lint setups -- unjustified nolint directives, disabled
  linters that should be enabled, overly permissive configs, and missing critical analyzers
parents:
- index.md
covers:
