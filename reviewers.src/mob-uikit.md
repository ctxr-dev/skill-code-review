...
id: mob-uikit
type: primary
focus: Detect retain cycles in closures, missing dealloc/deinit cleanup, Auto Layout ambiguity, massive
  view controllers, and non-weak delegate references in UIKit code.
parents:
- index.md
covers:
