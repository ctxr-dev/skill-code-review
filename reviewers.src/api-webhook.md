...
id: api-webhook
type: primary
focus: Detect webhook implementation gaps including missing signature verification, no retry with backoff,
  absent idempotency handling, unconfigured timeouts, and no secret rotation
parents:
- index.md
covers:
