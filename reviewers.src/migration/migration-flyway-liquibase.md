...
type: primary
focus: Detect Flyway and Liquibase pitfalls including non-repeatable migration editing, checksum mismatch,
  out-of-order execution, missing rollback support, baseline misuse, and environment-specific migration
  errors
parents:
- index.md
covers:
