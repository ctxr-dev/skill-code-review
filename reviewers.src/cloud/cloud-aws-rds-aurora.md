...
type: primary
focus: Detect RDS and Aurora misconfigurations including missing Multi-AZ, public accessibility, absent
  encryption, missing connection pooling, and inadequate backup and monitoring settings
parents:
- index.md
covers:
