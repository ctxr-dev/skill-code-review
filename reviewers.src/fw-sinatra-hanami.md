...
type: primary
focus: Detect Sinatra and Hanami pitfalls including missing CSRF protection, unescaped template rendering,
  hardcoded session secrets, missing security headers, monolith growth in Sinatra, and bypassed validation
  in Hanami that cause vulnerabilities or architectural decay.
parents:
- index.md
covers:
