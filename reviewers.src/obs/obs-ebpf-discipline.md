...
type: primary
focus: Detect eBPF program safety violations including missing bounds checks, verifier non-compliance,
  kernel compatibility issues, map size limits, and unsafe memory access
parents:
- index.md
covers:
