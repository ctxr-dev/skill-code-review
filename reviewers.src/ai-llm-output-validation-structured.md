...
type: primary
focus: Detect LLM output parsed without schema validation, JSON mode not used when available, missing
  retry on malformed output, lack of Pydantic/Zod validation, and raw LLM text rendered as HTML
parents:
- index.md
covers:
