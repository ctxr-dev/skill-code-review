...
type: primary
focus: Detect API Gateway misconfigurations including missing authorizers, absent WAF integration, permissive
  CORS, missing throttling, and request validation gaps
parents:
- index.md
covers:
