...
type: primary
focus: Detect overly permissive IAM policies, wildcard actions and resources, missing condition keys,
  and unsafe trust relationships in AWS IAM configurations
parents:
- index.md
covers:
