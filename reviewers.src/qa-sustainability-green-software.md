...
type: primary
focus: Detect unnecessary computation, oversized assets, missing caching for repeated expensive work,
  unnecessary network round-trips, idle resource consumption, and missing auto-scaling down
parents:
- index.md
covers:
