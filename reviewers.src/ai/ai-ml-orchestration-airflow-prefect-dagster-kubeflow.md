...
type: primary
focus: Detect DAG import side effects, oversized tasks, missing retries on transient failures, hardcoded
  connections, and absent failure alerting in ML pipeline orchestrators
parents:
- index.md
covers:
