...
id: db-clickhouse
type: primary
focus: Detect ClickHouse pitfalls around MergeTree engine selection, ORDER BY key design, materialized
  view synchronization, deduplication semantics, JOIN limitations, and bulk insert requirements
parents:
- index.md
covers:
