...
id: fe-build-vite
type: primary
focus: Detect Vite build misconfigurations that leak dev-only code into production, bloat bundles, expose
  environment variables, or degrade load performance.
parents:
- index.md
covers:
