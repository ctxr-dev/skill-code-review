...
id: pattern-facade
type: primary
focus: Detect misuse, over-application, and absence of the Facade pattern in subsystem-simplification
  code.
parents:
- index.md
covers:
...
- architecture
audit_surface:
- Facade has a cohesive, bounded responsibility -- all methods relate to a single subsystem or use case
  family
