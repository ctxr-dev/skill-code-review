...
type: primary
focus: Detect user input concatenated into prompts without sanitization, missing input/output guardrails,
  extractable system prompts, tool-use without authorization, and indirect injection via retrieved documents
parents:
- index.md
aliases:
