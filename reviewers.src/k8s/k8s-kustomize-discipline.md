...
type: primary
focus: Detect Kustomize anti-patterns including full-manifest patches, unpinned remote bases, missing
  namespace overlays, stale configMaps, and overlay complexity obscuring intent
parents:
- index.md
covers:
