...
id: orm-sqlalchemy
type: primary
focus: Detect SQLAlchemy pitfalls including session mismanagement, lazy loading N+1, detached instance
  access, connection pool misconfiguration, raw text() injection, and expire_on_commit confusion
parents:
- index.md
covers:
