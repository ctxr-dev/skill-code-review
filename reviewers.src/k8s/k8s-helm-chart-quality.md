...
type: primary
focus: Detect Helm chart pitfalls including hardcoded values in templates, missing defaults, absent schema
  validation, deprecated APIs, missing labels, and untested charts
parents:
- index.md
covers:
