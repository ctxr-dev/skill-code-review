...
id: cloud-aws-lambda
type: primary
focus: Detect Lambda configuration pitfalls including cold start risk, timeout/memory misconfiguration,
  missing dead-letter queues, secrets in environment variables, and VPC networking traps
parents:
- index.md
aliases:
- arch-serverless
