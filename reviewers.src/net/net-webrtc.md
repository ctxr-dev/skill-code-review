...
id: net-webrtc
type: primary
focus: Detect WebRTC configuration issues including hardcoded TURN credentials, missing TURN fallback,
  SDP manipulation vulnerabilities, and missing encryption validation
parents:
- index.md
covers:
