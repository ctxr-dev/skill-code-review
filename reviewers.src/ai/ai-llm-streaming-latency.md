...
type: primary
focus: Detect streaming not used for user-facing responses, TTFT not measured, missing partial response
  handling, unhandled streaming errors, and buffering that defeats the purpose of streaming
parents:
- index.md
covers:
