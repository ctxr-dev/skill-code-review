...
type: primary
focus: Detect experiments not logged, hyperparameters not tracked, model artifacts not versioned, missing
  comparison between runs, and absent model registry usage
parents:
- index.md
covers:
