...
type: primary
focus: Detect supply chain vulnerabilities including unpinned dependencies, mutable image tags, missing
  lock files, unsigned artifacts, absent SBOM generation, and dependency confusion risks
parents:
- index.md
aliases:
