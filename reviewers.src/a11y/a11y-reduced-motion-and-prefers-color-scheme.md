...
type: primary
focus: Detect animations without prefers-reduced-motion check, missing forced colors support, dark mode
  contrast failures, and transition durations not respecting user preference.
parents:
- index.md
covers:
