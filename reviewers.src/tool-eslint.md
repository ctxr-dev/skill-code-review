...
id: tool-eslint
type: primary
focus: Detect misconfigured, suppressed, or under-utilized ESLint setups -- unjustified disables, missing
  recommended presets, flat config migration issues, and conflicting rule definitions
parents:
- index.md
covers:
