...
id: fw-django
type: primary
focus: Detect Django framework-level pitfalls in security settings, middleware configuration, admin exposure,
  view permissions, file upload handling, and production hardening that cause vulnerabilities or deployment
  failures beyond ORM-specific issues.
parents:
- index.md
covers:
