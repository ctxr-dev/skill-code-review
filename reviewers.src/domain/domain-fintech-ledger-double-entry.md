...
type: primary
focus: Detect single-entry bookkeeping, non-idempotent payment processing, floating-point monetary math,
  missing audit trails, and broken ledger invariants in double-entry accounting systems
parents:
- index.md
covers:
