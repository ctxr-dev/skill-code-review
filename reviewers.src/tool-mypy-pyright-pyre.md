...
type: primary
focus: Detect misconfigured or under-utilized Python type checkers -- type:ignore without error codes,
  missing strict mode, Any leaking into public APIs, missing py.typed markers, and outdated stubs
parents:
- index.md
covers:
