...
type: primary
focus: Detect CI/CD caching issues including overly broad cache keys, cache poisoning risks, missing lockfile-based
  invalidation, cross-PR cache security, and missing compression
parents:
- index.md
aliases:
