...
id: a11y-wcag-2-2-aa
type: primary
focus: Detect WCAG 2.2 Level AA violations including missing alt text, insufficient color contrast, missing
  form labels, absent landmarks, broken focus management, and undersized touch targets.
parents:
- index.md
covers:
