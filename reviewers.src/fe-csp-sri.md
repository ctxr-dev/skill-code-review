...
id: fe-csp-sri
type: primary
focus: Detect missing or misconfigured Content-Security-Policy headers and missing Subresource Integrity
  hashes that leave applications vulnerable to XSS, script injection, and CDN compromise.
parents:
- index.md
aliases:
