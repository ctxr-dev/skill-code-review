...
type: primary
focus: Detect software licensing compliance gaps including missing LICENSE file, copyleft (GPL/AGPL) dependencies
  in proprietary products, license incompatibility between dependencies, missing attribution, absent CLA/DCO
