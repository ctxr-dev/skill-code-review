...
id: orm-ecto-elixir
type: primary
focus: Detect Ecto/Elixir pitfalls including preload vs join confusion, Repo transaction misuse, changeset
  validation gaps, raw fragment injection, migration lock timeout, and sandbox leaks
parents:
- index.md
covers:
