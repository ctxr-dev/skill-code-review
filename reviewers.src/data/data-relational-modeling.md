...
type: primary
focus: Detect normalization gaps, missing constraints, wrong data types, unjustified denormalization,
  and missing indexes on foreign keys in relational database schemas
parents:
- index.md
covers:
