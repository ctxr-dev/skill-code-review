...
type: primary
focus: Detect GitHub Actions security and reliability issues including unpinned actions, secrets exposure,
  excessive permissions, pull_request_target dangers, and missing concurrency controls
parents:
- index.md
covers:
