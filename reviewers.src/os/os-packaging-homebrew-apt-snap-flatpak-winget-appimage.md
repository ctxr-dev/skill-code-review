...
type: primary
focus: Detect OS-packaging hazards across Homebrew, Debian/apt, Snap, Flatpak, RPM, Chocolatey, winget,
  and AppImage -- missing checksums, weak sandboxing, hardcoded paths, unsigned artefacts, and broken
  uninstall cleanup
parents:
- index.md
covers:
