...
id: test-integration
type: primary
focus: Ensure integration tests use real dependencies correctly, isolate test state, verify API contracts,
  and avoid over-mocking
parents:
- index.md
covers:
...
- tests
audit_surface:
- Test labeled 'integration' that mocks the database, HTTP client, or message broker it claims to integrate
  with
