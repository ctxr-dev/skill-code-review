...
type: primary
focus: Detect email-sending misconfiguration that harms deliverability, reputation, and compliance --
  SPF, DKIM, DMARC, bounce/complaint handling, unsubscribe, and IP warming
parents:
- index.md
covers:
