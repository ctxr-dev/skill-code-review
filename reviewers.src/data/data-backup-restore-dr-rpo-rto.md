...
type: primary
focus: Detect missing backup strategies, untested restore procedures, undefined RPO/RTO, missing point-in-time
  recovery, and absent cross-region replication for disaster recovery
parents:
- index.md
covers:
