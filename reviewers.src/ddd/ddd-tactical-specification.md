...
type: primary
focus: Detect complex query conditions scattered across services instead of specification objects, non-composable
  specifications, and specifications placed in the wrong architectural layer.
parents:
- index.md
covers:
...
- Query method name encoding business rule (findActiveOverdueOrdersForVipCustomers) instead of accepting
  a specification
languages: all
tags:
- specification
