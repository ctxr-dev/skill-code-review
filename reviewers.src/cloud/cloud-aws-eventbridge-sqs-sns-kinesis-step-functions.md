...
type: primary
focus: Detect messaging and orchestration pitfalls including missing DLQs, absent retry configuration,
  incorrect visibility timeouts, Kinesis shard sizing, and Step Functions error handling gaps
parents:
- index.md
covers:
