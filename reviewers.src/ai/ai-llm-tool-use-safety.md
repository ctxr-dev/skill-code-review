...
type: primary
focus: Detect tools executing arbitrary code from LLM output, tools without authorization checks, unvalidated
  tool output returned to the LLM, missing tool timeouts, and non-idempotent tool side effects
parents:
- index.md
