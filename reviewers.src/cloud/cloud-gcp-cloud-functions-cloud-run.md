...
type: primary
focus: Detect cold start neglect, missing IAM invoker restrictions, secret leaks in env vars, and misconfigured
  concurrency in Cloud Functions and Cloud Run
parents:
- index.md
covers:
