...
id: iac-nix
type: primary
focus: Detect Nix and NixOS misconfigurations including unpinned flake inputs, impure derivations, missing
  flake checks, large closure sizes, uncached store paths in CI, missing devShell, and unfree package
  allowances
parents:
- index.md
covers:
