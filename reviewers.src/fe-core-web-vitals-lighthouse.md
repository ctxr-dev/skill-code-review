...
type: primary
focus: Detect code patterns that degrade Core Web Vitals (LCP, CLS, INP) and Lighthouse scores, including
  render-blocking resources, layout shifts, and long tasks.
parents:
- index.md
covers:
