...
type: primary
focus: Detect trace sampling misconfigurations that lose critical signal, over-sample routine traffic,
  or produce inconsistent sampling decisions across services
parents:
- index.md
covers:
