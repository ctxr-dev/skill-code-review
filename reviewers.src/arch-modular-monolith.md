...
type: primary
focus: Detect module boundary violations including direct access to another module's internals, missing
  public API surfaces, and shared database tables between modules
parents:
- index.md
aliases:
