...
type: primary
focus: Detect repositories returning DTOs instead of aggregates, query methods bypassing aggregate roots,
  repositories containing business logic, and per-entity repositories instead of per-aggregate.
parents:
- index.md
aliases:
