...
type: primary
focus: Detect main thread work causing frame drops, unreleased wake locks, background polling without
  constraints, image decoding on the main thread, and missing offline caching strategies in mobile apps.
parents:
- index.md
covers:
