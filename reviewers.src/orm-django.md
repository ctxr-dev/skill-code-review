...
id: orm-django
type: primary
focus: Detect Django ORM pitfalls including N+1 from missing select_related/prefetch_related, raw SQL
  injection, migration squashing risks, queryset evaluation timing, F/Q expression misuse, and signal
  side effects
parents:
- index.md
covers:
