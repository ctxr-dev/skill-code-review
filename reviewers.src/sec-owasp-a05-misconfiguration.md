...
type: primary
focus: Detect security misconfigurations including debug mode in production, missing security headers,
  default credentials, verbose error exposure, and unnecessary features enabled
parents:
- index.md
covers:
