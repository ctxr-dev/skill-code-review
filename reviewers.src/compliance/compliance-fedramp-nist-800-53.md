...
type: primary
focus: Detect FedRAMP and NIST 800-53 compliance gaps including non-FIPS 140-2 cryptography, missing continuous
  monitoring, boundary protection gaps, absent audit record generation, and MFA not enforced
parents:
- index.md
covers:
