...
type: primary
focus: Detect missing API key rotation, hardcoded model names, absent retry with backoff on rate limits,
  missing streaming error handling, unvalidated responses, absent usage tracking, and max_tokens not set
parents:
- index.md
covers:
