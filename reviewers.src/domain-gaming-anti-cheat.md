...
type: primary
focus: Detect client-trusted game state, missing server-side validation of player actions, speed and teleport
  hack vectors, exploitable game economies, replay attacks, and leaderboard manipulation in game systems
parents:
- index.md
covers:
