...
type: primary
focus: Detect Knex/Objection.js pitfalls including knex.raw injection, migration lock table issues, batch
  numbering conflicts, Objection graph operations, and transaction scope misuse
parents:
- index.md
covers:
