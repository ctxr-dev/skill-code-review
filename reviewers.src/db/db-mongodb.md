...
id: db-mongodb
type: primary
focus: Detect MongoDB pitfalls around schema validation gaps, index strategy, aggregation pipeline misuse,
  sharding key selection, ObjectId assumptions, and WiredTiger cache pressure
parents:
- index.md
covers:
