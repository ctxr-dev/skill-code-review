...
id: db-mysql-mariadb
type: primary
focus: Detect MySQL and MariaDB pitfalls around storage engine selection, replication lag, deadlocks,
  gap locks, character set mismatches, and missing slow query analysis
parents:
- index.md
covers:
