...
type: primary
focus: Aggregator gate that cross-references specialist reviewer verdicts and prerequisite signals to
  determine whether a change is safe to merge and release
parents:
- index.md
covers:
