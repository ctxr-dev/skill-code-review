...
type: primary
focus: Detect misconfigured or under-utilized SAST tools -- SonarQube quality gates bypassed, Semgrep
  rules not in CI, CodeQL queries missing for critical paths, untriaged false positives, and custom rules
  without tests
parents:
- index.md
covers:
