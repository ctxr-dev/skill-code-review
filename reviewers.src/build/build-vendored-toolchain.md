...
type: primary
focus: Detect vendored dependency and toolchain issues including stale vendored code, unpinned toolchain
  versions, missing checksums for vendored binaries, and unattributed vendored source
parents:
- index.md
covers:
