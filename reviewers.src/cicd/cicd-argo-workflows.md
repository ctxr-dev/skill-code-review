...
type: primary
focus: Detect Argo Workflows security and reliability issues including missing RBAC on workflow templates,
  secrets in workflow specs, absent artifact garbage collection, missing resource limits, and retry without
  backoff
parents:
- index.md
aliases:
