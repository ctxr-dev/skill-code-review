...
type: primary
focus: Detect unbounded agent loops, missing maximum iterations, absent human-in-the-loop for destructive
  actions, lost agent state on crash, missing reflection steps, and uncoordinated multi-agent systems
parents:
- index.md
covers:
