...
type: primary
focus: Detect KMS key misconfigurations including missing rotation, overly broad key policies, absent
  encryption context, and inefficient data key usage patterns
parents:
- index.md
aliases:
