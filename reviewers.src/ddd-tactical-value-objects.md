...
type: primary
focus: Detect value objects with accidental identity, mutable value objects, equality not based on attributes,
  value objects with setters, and primitives used where value objects should exist.
parents:
- index.md
covers:
