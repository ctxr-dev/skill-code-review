...
type: primary
focus: Detect time-series database pitfalls around hypertable chunk sizing, continuous aggregate freshness,
  retention policies, tag vs field confusion, and cardinality explosion
parents:
- index.md
aliases:
