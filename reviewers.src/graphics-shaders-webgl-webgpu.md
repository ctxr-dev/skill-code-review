...
type: primary
focus: Detect GPU hazards in shaders and graphics pipelines -- warp divergence, CPU-GPU sync stalls, missing
  precision, unfiltered textures, and undiagnosed errors in WebGL and WebGPU code
parents:
- index.md
covers:
