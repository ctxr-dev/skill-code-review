...
type: primary
focus: Detect misconfigurations in SOPS, Sealed Secrets, and HashiCorp Vault including missing key rotation,
  outdated controllers, overly broad Vault policies, unencrypted secrets at rest, missing rotation schedules,
  plaintext secrets in git history, and absent audit trails
parents:
- index.md
aliases:
