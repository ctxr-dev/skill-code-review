...
type: primary
focus: Detect misconfigurations in Python package managers including unpinned dependencies, missing hash
  verification, editable installs in production, and build isolation issues
parents:
- index.md
covers:
