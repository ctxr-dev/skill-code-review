...
id: build-cargo
type: primary
focus: Detect Cargo misconfigurations including missing Cargo.lock in binary crates, wildcard dependencies,
  unsafe build scripts, missing edition declaration, and undocumented features
parents:
- index.md
covers:
