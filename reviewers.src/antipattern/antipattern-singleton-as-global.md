...
type: primary
focus: Detect singletons used as socially acceptable global mutable state, bypassing dependency injection
  and damaging testability
parents:
- index.md
aliases:
- pattern-singleton
...
- Singleton used as a service locator -- code calls Singleton.get(ServiceType) instead of receiving the
  service
