...
id: perf-jit-warmup
type: primary
focus: Detect benchmarking before JIT warmup, JIT deoptimization triggers, megamorphic call sites, and
  class hierarchy changes that invalidate compiled code
parents:
- index.md
covers:
