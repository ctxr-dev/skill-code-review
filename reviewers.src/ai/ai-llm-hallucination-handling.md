...
type: primary
focus: Detect missing grounding or citation mechanisms, output not cross-checked against source, absent
  user warnings about potential inaccuracy, missing confidence scores, and hallucinated URLs or references
parents:
- index.md
covers:
