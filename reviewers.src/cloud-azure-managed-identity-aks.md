...
type: primary
focus: Detect ClientSecretCredential usage instead of Managed Identity, overly broad Azure RBAC, and AKS
  cluster misconfigurations for identity and networking
parents:
- index.md
covers:
