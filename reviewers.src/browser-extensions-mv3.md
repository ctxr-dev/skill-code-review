...
type: primary
focus: Detect browser-extension pitfalls in Manifest V3 -- MV2 leftovers, over-broad host permissions,
  unsafe CSP, service-worker lifecycle assumptions, deprecated executeScript APIs, and missing declarativeNetRequest
  validation
parents:
- index.md
covers:
