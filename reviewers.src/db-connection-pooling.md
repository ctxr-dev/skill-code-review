...
type: primary
focus: Detect database connection pooling pitfalls around pool sizing, leak detection, idle timeout, PgBouncer
  mode selection, HikariCP configuration, and connection-per-request anti-patterns
parents:
- index.md
covers:
