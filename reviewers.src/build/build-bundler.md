...
id: build-bundler
type: primary
focus: Detect Bundler misconfigurations including missing Gemfile.lock, unpinned gem versions, git source
  gems without ref pinning, platform-specific gem omissions, and missing Ruby version requirements
parents:
- index.md
covers:
