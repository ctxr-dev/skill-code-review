...
type: primary
focus: Detect classes or modules that centralize too many responsibilities, becoming universal coupling
  magnets that everything depends on
parents:
- index.md
...
- Class name uses generic suffix (Manager, Handler, Processor, Service, Engine, Core) without narrow domain
  qualifier
