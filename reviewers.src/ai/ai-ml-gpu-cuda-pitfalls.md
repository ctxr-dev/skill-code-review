...
type: primary
focus: Detect CPU-GPU transfer in hot loops, missing CUDA stream synchronization, OOM without gradient
  checkpointing, kernel launch overhead, and pinned memory not used for data transfer
parents:
- index.md
covers:
