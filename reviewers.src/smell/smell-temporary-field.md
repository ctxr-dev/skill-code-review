...
type: primary
focus: Detect class fields that are only valid in certain states or methods, leading to null checks and
  temporal coupling.
parents:
- index.md
covers:
...
- Fields typed as Optional/Nullable have a genuine domain reason (not just "sometimes we don't have it
  yet")
