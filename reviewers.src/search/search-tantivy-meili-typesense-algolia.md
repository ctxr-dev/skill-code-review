...
type: primary
focus: Detect exposed admin keys, missing schema configuration (synonyms, facets, ranking), reindex and
  hybrid-search pitfalls across Tantivy, Meilisearch, Typesense, and Algolia
parents:
- index.md
aliases:
