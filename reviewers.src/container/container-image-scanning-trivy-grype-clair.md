...
type: primary
focus: Detect gaps in container image vulnerability scanning including missing CI integration, ignored
  critical findings, scan-only-at-build patterns, and incomplete package coverage
parents:
- index.md
covers:
