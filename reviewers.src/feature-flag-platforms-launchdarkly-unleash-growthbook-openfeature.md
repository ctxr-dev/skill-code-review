...
type: primary
focus: Detect misuse of feature-flag platforms (LaunchDarkly, Unleash, GrowthBook, OpenFeature) -- evaluation
  context, default variations, expiry, hot-path evaluation, PII leakage, and cleanup
parents:
- index.md
aliases:
