...
type: primary
focus: Detect A/B test and experimentation gaps including missing primary metric, peeking before sample
  size reached, multiple-comparisons without correction, unmonitored SRM, broken stratified assignment,
  missing guardrail metrics, no power analysis, and no post-rollout holdout validation
parents:
- index.md
covers:
