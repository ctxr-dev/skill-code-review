...
id: fw-spring
type: primary
focus: Detect Spring Boot and Spring Framework pitfalls including dependency injection anti-patterns,
  security misconfigurations, WebFlux blocking violations, transaction proxy failures, and actuator exposure
  that cause vulnerabilities or silent misbehavior.
parents:
- index.md
covers:
