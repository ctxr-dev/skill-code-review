...
type: primary
focus: Detect deployment strategy issues including big-bang deploys without progressive rollout, canary
  without metrics comparison, missing rollback triggers, stale feature flags, deploys without smoke tests,
  and missing deploy freeze mechanisms
parents:
- index.md
aliases:
- qa-deployability
