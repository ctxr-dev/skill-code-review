...
type: primary
focus: Detect Rust data access pitfalls including diesel compile-time safety gaps vs sqlx runtime query
  verification, connection pool misconfiguration (deadpool/bb8/r2d2), migration ordering, and type mapping
  errors
parents:
- index.md
covers:
