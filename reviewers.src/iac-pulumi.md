...
id: iac-pulumi
type: primary
focus: Detect Pulumi misconfigurations including plaintext secrets in config, unencrypted state backends,
  missing ComponentResource grouping, unpinned provider versions, and leaking stack outputs
parents:
- index.md
covers:
