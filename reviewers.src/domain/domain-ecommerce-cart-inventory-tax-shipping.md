...
type: primary
focus: Detect inventory race conditions, stale cart prices at checkout, client-side tax calculations,
  negative quantity exploits, unbounded discount stacking, and missing order idempotency in e-commerce
  systems
parents:
- index.md
covers:
