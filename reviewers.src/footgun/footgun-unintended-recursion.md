...
type: primary
focus: 'Detect unintended or unbounded recursion and re-entrancy where a function, wrapper, getter, or
  cache calls its own entry point (self/this/super/public API) instead of the inner delegate, or recurses
  with no progress toward a base case'
parents:
- index.md
covers:
