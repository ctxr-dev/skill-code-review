...
type: primary
focus: Detect Kubernetes manifest misconfigurations including missing resource limits, absent probes,
  insecure securityContext, missing disruption budgets, and image hygiene issues
parents:
- index.md
covers:
