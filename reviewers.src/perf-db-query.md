...
id: perf-db-query
type: primary
focus: Detect full table scans, missing indexes, SELECT *, unbounded result sets, expensive JOINs, and
  query patterns that degrade under production data volumes
parents:
- index.md
aliases:
