...
type: primary
focus: Detect GPU training without mixed precision, data loading bottlenecks, missing gradient clipping,
  absent learning rate schedules, overfitting from no validation split, and reproducibility issues from
  unseeded randomness
parents:
- index.md
covers:
