...
type: primary
focus: Detect missing or misconfigured Kubernetes NetworkPolicies including absent default-deny, overly
  broad selectors, missing DNS egress exceptions, and selector mismatches
parents:
- index.md
covers:
