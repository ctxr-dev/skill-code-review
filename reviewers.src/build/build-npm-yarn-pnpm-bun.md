...
type: primary
focus: Detect misconfigurations in Node.js package managers including missing lockfiles, wildcard versions,
  unreviewed lifecycle scripts, registry misconfigurations, and production bundle bloat
parents:
- index.md
covers:
