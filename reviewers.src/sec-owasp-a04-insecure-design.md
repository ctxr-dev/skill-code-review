...
type: primary
focus: Detect missing security controls that stem from flawed design -- absent rate limiting, business
  logic flaws, missing trust boundaries, and insufficient resource constraints
parents:
- index.md
covers:
...
- Business logic flaws allowing negative quantities, zero-cost purchases, or race conditions in financial
  operations
