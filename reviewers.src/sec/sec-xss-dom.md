...
id: sec-xss-dom
type: primary
focus: Detect DOM-based Cross-Site Scripting where user-controlled data flows into dangerous browser APIs
...
- Angular template using [innerHTML] without passing through DomSanitizer.bypassSecurityTrustHtml on validated
  content
