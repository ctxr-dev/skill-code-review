...
type: primary
focus: Detect GlobalScope leaks, missing coroutine cancellation, Flow collection blocking the main thread,
  StateFlow vs SharedFlow misuse, and uncaught exceptions in launch blocks.
parents:
- index.md
covers:
