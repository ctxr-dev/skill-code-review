...
type: primary
focus: Detect missing or misconfigured infrastructure drift detection including absent drift checks, non-actionable
  alerts, missing automated remediation, unreconciled manual changes, unscheduled state refresh, and missing
  drift reports in CI
parents:
- index.md
covers:
