...
id: compliance-soc2
type: primary
focus: Detect SOC 2 Trust Service Criteria gaps including missing access reviews, absent change management
  process, missing availability monitoring, no incident response hooks, missing encryption, and vendor
  risk signals
parents:
- index.md
covers:
