...
type: primary
focus: Detect service mesh misconfigurations including permissive mTLS, missing authorization policies,
  absent timeouts and circuit breakers, unenforced sidecar injection, and mesh bypass vectors
parents:
- index.md
aliases:
