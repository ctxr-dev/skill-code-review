...
type: primary
focus: Detect non-reproducible build patterns, missing provenance attestation, absent SLSA compliance
  measures, unsigned artifacts, and missing build attestation
parents:
- index.md
covers:
