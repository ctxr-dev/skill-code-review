...
type: primary
focus: Detect Elasticsearch and OpenSearch pitfalls around mapping explosion, shard sizing, refresh interval,
  query vs filter context, deep pagination, and analyzer misconfiguration
parents:
- index.md
covers:
