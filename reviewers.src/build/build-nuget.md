...
id: build-nuget
type: primary
focus: Detect NuGet misconfigurations including missing packages.lock.json, floating versions, unpinned
  package sources, deprecated packages, and suppressed NU analyzer warnings
parents:
- index.md
covers:
