...
type: primary
focus: Detect misconfigured Kubernetes admission policies including audit-mode-only enforcement, missing
  critical controls, overly broad exclusions, and untested policy logic
parents:
- index.md
covers:
