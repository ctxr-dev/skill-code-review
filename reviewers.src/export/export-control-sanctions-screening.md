...
type: primary
focus: Detect export-control and sanctions screening gaps including missing sanctioned-country blocking,
  unclassified encryption export, missing denied-party screening, cloud region serving embargoed jurisdictions,
  absent TSU notification for open-source crypto, stale sanctions lists, and deemed-export access controls
parents:
- index.md
covers:
