...
type: primary
focus: Detect insecure MQTT/CoAP transport, overly broad topic ACLs, unsigned OTA updates, hardcoded device
  credentials, missing firmware rollback, telemetry flooding, and absent device attestation in IoT fleet
  systems
parents:
- index.md
covers:
