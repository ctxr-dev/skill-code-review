...
id: db-redis
type: primary
focus: Detect Redis pitfalls around memory limits, eviction policy, persistence gaps, pub/sub reliability,
  Lua script safety, cluster mode key distribution, and key naming conventions
parents:
- index.md
covers:
