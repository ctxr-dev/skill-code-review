...
type: primary
focus: Detect blocking I/O where async multiplexing would scale, wrong event loop model, io_uring submission
  queue issues, and epoll edge vs level trigger misuse
parents:
- index.md
covers:
