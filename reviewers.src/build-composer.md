...
id: build-composer
type: primary
focus: Detect Composer misconfigurations including missing composer.lock, wildcard versions, scripts with
  shell commands, missing platform config, and dev dependencies in production autoload
parents:
- index.md
covers:
