...
type: primary
focus: Detect data-fetching pitfalls across React Query, SWR, Apollo Client, Relay, and urql including
  cache invalidation bugs, missing error states, and overfetching.
parents:
- index.md
covers:
