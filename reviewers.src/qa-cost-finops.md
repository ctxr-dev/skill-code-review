...
id: qa-cost-finops
type: primary
focus: Detect unbounded cloud resource scaling, missing cost alerts, expensive queries without optimization,
  unused provisioned resources, excessive logging verbosity, and missing cost-allocation tags
parents:
- index.md
aliases:
