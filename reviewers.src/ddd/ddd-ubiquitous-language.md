...
type: primary
focus: Detect code names that diverge from domain terminology, inconsistent naming across bounded contexts,
  technical jargon where domain language belongs, and glossary drift between code and domain experts.
parents:
- index.md
covers:
