...
type: primary
focus: Detect missing cancellable storage, publishers not completed, sink without strong self management,
  scheduler misuse, and incorrect Subject vs Publisher choices in Combine and reactive frameworks.
parents:
- index.md
covers:
