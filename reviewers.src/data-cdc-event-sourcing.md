...
type: primary
focus: Detect CDC lag risks, missing ordering guarantees, schema compatibility gaps, and consumer idempotency
  failures in change data capture and event sourcing pipelines
parents:
- index.md
