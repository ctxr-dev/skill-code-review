...
type: primary
focus: Detect design patterns applied where none is needed, creating unnecessary structural complexity
  for problems a plain function or direct code would solve
parents:
- index.md
covers:
...
- Class named XxxFactory, XxxStrategy, XxxObserver, XxxCommand whose structure does not match the pattern's
  intent
