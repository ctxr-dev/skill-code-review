...
type: primary
focus: Detect Phoenix/Elixir pitfalls in CSRF protection, HEEx template escaping, LiveView input validation,
  authorization plugs, Ecto raw SQL injection, channel authentication, PubSub authorization, and GenServer
