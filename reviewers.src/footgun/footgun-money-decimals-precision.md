...
type: primary
focus: Detect use of binary floating-point for monetary values, currency precision mismatches, unspecified
  rounding modes, and unit confusion in financial arithmetic
parents:
- index.md
covers:
