...
type: primary
focus: Detect gaps in incident response, postmortem discipline, chaos engineering, and DR drills -- absent
  templates, blameful language, unowned action items, untested game-days, and repeated incidents without
  systemic fixes
parents:
- index.md
covers:
