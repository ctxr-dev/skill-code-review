...
type: primary
focus: Detect OpenAPI and AsyncAPI documentation-level issues including missing examples, absent descriptions,
  no versioning strategy, and lack of CI validation
parents:
- index.md
aliases:
