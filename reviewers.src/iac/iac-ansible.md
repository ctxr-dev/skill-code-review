...
id: iac-ansible
type: primary
focus: Detect Ansible misconfigurations including plaintext passwords in variables, missing privilege
  escalation controls, unnotified handlers, roles without tests, hardcoded hosts, missing vault encryption,
