...
id: build-mix-elixir
type: primary
focus: Detect Mix misconfigurations including missing mix.lock, git dependencies without ref pinning,
  missing :only for dev/test deps, and absent compilation warnings-as-errors
parents:
- index.md
covers:
