...
type: primary
focus: Detect main context blocking UI, missing background context for writes, fetch requests without
  predicate or sort causing full scans, missing migration plans, and concurrency violations in Core Data
  and SwiftData.
parents:
- index.md
covers:
