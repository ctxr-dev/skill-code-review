...
type: primary
focus: Detect pitfalls specific to Rust web frameworks (Axum, Actix-web, Rocket) including silent extractor
  failures, blocking on async runtime, shared state races, missing middleware, and panic-induced worker
  crashes.
parents:
- index.md
covers:
