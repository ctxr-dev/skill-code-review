...
type: primary
focus: Detect missing health checks, absent autoscaling, ephemeral storage misuse, secrets in config files,
  and single-region deployments on Fly.io, Render, and Railway
parents:
- index.md
covers:
