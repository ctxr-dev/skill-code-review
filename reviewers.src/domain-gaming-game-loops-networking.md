...
type: primary
focus: Detect frame-rate-dependent physics, client-authoritative state, missing server reconciliation,
  broken network prediction, ECS archetype fragmentation, and tick rate mismatches in game loops and networking
parents:
- index.md
covers:
