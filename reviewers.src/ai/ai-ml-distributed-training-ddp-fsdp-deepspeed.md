...
type: primary
focus: Detect gradient synchronization bugs, uneven data distribution, missing checkpoint saving, FSDP
  shard configuration mismatches, NCCL timeouts, and DeepSpeed ZeRO stage mischoice
parents:
- index.md
covers:
