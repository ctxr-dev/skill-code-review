...
type: primary
focus: Detect optimization without profiling evidence, microbenchmarks measuring the wrong thing, profiler
  overhead distorting results, and missing flamegraph analysis
parents:
- index.md
aliases:
