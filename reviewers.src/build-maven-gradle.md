...
type: primary
focus: Detect Maven and Gradle misconfigurations including missing dependency locking, SNAPSHOT dependencies
  in releases, missing BOM alignment, build scan credential exposure, and absent enforcer rules
parents:
- index.md
covers:
