...
type: primary
focus: Detect service worker and PWA pitfalls including stale caches, missing update prompts, offline
  fallback gaps, and background sync without retry limits.
parents:
- index.md
covers:
