...
id: fw-remix
type: primary
focus: Detect Remix-specific pitfalls in loader/action design, data flow, error boundaries, and form handling
  that cause data leaks, mutation bugs, or degraded UX.
parents:
- index.md
covers:
