...
id: iac-argocd
type: primary
focus: Detect Argo CD misconfigurations including sync policy gaps, missing health checks, overly permissive
  RBAC, ApplicationSet without progressive rollout, and secrets in Application manifests
parents:
- index.md
covers:
