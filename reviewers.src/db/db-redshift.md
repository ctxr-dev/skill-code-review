...
id: db-redshift
type: primary
focus: Detect Redshift pitfalls around distribution keys, sort keys, VACUUM/ANALYZE maintenance, WLM queue
  configuration, Spectrum external table misuse, and encoding selection
parents:
- index.md
covers:
