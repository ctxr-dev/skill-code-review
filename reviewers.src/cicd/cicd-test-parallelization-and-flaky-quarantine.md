...
type: primary
focus: Detect CI test execution issues including uneven test splitting, missing flaky test quarantine,
  retries masking real failures, absent timing data for splitting, and missing flaky detection automation
parents:
- index.md
covers:
