...
type: primary
focus: Detect sandboxed container runtime misconfigurations including workloads missing RuntimeClass,
  gVisor syscall compatibility gaps, Kata nested virtualization issues, and missing fallback runtime strategies
parents:
- index.md
covers:
