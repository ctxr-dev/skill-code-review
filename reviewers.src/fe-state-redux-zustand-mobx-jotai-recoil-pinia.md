...
type: primary
focus: Detect state management anti-patterns across Redux, Zustand, MobX, Jotai, Recoil, and Pinia that
  cause unnecessary re-renders, stale data, or unmaintainable state shapes.
parents:
- index.md
covers:
