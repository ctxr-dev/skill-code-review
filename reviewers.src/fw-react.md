...
id: fw-react
type: primary
focus: Detect React-specific pitfalls in hooks, rendering, memoization, and component design that cause
  bugs, memory leaks, or unnecessary re-renders.
parents:
- index.md
covers:
...
- dangerouslySetInnerHTML prop on any element where the __html value traces to user input, API response,
  or URL
