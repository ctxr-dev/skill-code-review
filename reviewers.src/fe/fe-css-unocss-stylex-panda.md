...
type: primary
focus: Detect atomic CSS pitfalls in UnoCSS, StyleX, and Panda CSS around extraction failures, runtime
  overhead, preset misconfiguration, and design token drift.
parents:
- index.md
covers:
