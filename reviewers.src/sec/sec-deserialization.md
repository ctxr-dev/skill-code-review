...
type: primary
focus: Detect insecure deserialization patterns across all major languages where untrusted data is deserialized
  into executable object graphs
parents:
- index.md
aliases:
...
- .NET BinaryFormatter, SoapFormatter, NetDataContractSerializer, and ObjectStateFormatter on untrusted
  streams
...
- 'Rust serde with #[serde(tag)] or #[serde(untagged)] on externally-sourced enums allowing arbitrary
  variant selection'
