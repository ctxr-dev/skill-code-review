...
id: tool-tsc-flow
type: primary
focus: Detect misconfigured or under-utilized TypeScript/Flow type checking -- unjustified ts-ignore/ts-expect-error,
  strict mode disabled, any casts without justification, skipLibCheck hiding errors, and missing test
  tsconfig
parents:
- index.md
covers:
