...
type: primary
focus: Detect RAG pipeline issues including improper chunk sizing, missing overlap, retrieval without
  reranking, absent relevance thresholds, context window overflow, and missing evaluation metrics
parents:
- index.md
covers:
