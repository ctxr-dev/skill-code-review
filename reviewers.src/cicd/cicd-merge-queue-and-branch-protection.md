...
type: primary
focus: Detect branch protection and merge queue issues including unprotected main branches, missing required
  reviews, missing status checks, allowed force push, absent merge queue for high-traffic repos, and missing
  signed commits
parents:
- index.md
covers:
