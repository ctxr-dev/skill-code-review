...
type: primary
focus: Detect MCP tools without input schema validation, missing tool descriptions, overly broad tool
  capabilities, missing error responses, transport security issues, and absent rate limiting on tool calls
parents:
- index.md
covers:
