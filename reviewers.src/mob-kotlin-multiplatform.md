...
type: primary
focus: Detect expect/actual declaration mismatches, platform-specific code leaking into common modules,
  missing iOS memory management (autoreleasepool), and shared mutable state without proper synchronization
