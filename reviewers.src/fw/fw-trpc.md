...
id: fw-trpc
type: primary
focus: Detect tRPC security and runtime pitfalls including publicProcedure on protected endpoints, missing
  input validation, inconsistent middleware application, subscription resource leaks, unbounded response
  payloads, error detail leakage, and missing rate limiting.
parents:
- index.md
