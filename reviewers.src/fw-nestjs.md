...
id: fw-nestjs
type: primary
focus: Detect NestJS-specific pitfalls in dependency injection, validation pipes, guards, interceptors,
  module architecture, and decorator usage that cause security gaps, circular dependencies, or architectural
  violations.
parents:
- index.md
covers:
