...
type: primary
focus: Detect copy-pasted code blocks that introduce duplication, divergence risk, and latent bugs from
...
- Variable name from a different context left in the pasted code (stale name — the highest-severity copy-paste
  bug)
