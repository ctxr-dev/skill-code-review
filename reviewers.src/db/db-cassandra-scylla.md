...
type: primary
focus: Detect Cassandra and ScyllaDB pitfalls around partition key design, tombstone accumulation, compaction
  strategy, consistency levels, lightweight transactions, and materialized view lag
parents:
- index.md
covers:
