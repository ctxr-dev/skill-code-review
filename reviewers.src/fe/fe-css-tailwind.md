...
id: fe-css-tailwind
type: primary
focus: Detect Tailwind CSS misconfigurations that bloat production CSS, break design consistency, or create
  maintainability issues from utility class misuse.
parents:
- index.md
covers:
