...
type: primary
focus: Detect Hibernate/JPA pitfalls including LazyInitializationException, N+1 with fetch joins, second-level
  cache staleness, flush mode confusion, JPQL injection, and entity lifecycle misuse
parents:
- index.md
covers:
