...
type: primary
focus: Detect Kubernetes operator and CRD design flaws including non-idempotent reconcilers, missing finalizers,
  absent status updates, overly broad watches, and CRD validation gaps
parents:
- index.md
covers:
