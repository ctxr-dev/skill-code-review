...
type: primary
focus: Detect accessibility regressions, theme inconsistencies, bundle bloat, and API misuse when customizing
  component libraries like shadcn/ui, Radix, MUI, Ant Design, and Chakra UI.
parents:
- index.md
covers:
