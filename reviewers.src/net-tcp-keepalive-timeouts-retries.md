...
type: primary
focus: Detect TCP configuration issues including missing keepalive, absent connect/read/write timeouts,
  Nagle interference with latency-sensitive traffic, and connection pool health gaps
parents:
- index.md
covers:
