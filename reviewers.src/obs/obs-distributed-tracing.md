...
type: primary
focus: Detect missing span creation for external calls, broken trace context propagation, incorrect span
  granularity, missing error recording, and incomplete span attributes
parents:
- index.md
covers:
