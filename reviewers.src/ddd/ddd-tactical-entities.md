...
type: primary
focus: Detect entities without identity, entity equality by value instead of ID, entities exposing state
  without behavior, and entities managing other entities' lifecycle.
parents:
- index.md
covers:
