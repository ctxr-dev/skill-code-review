...
id: api-grpc
type: primary
focus: Detect protobuf design issues, backward compatibility violations, streaming misuse, incorrect error
  codes, missing deadline propagation, and oversized messages
parents:
- index.md
aliases:
- net-grpc-streaming
