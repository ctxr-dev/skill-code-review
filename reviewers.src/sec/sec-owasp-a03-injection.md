...
type: primary
focus: Detect injection vulnerabilities where untrusted input is concatenated into queries, commands,
  templates, or interpreters without proper sanitization or parameterization
parents:
- index.md
aliases:
- sec-ssti
