...
type: primary
focus: Detect Docker Compose pitfalls including missing healthchecks, unguarded depends_on, host path
  mounts without read-only, secrets in environment, missing resource limits, and privileged mode
parents:
- index.md
covers:
