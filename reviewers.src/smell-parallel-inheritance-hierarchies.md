...
type: primary
focus: Detect mirrored class hierarchies where adding a subclass in one tree forces adding a corresponding
  subclass in another
parents:
- index.md
covers:
...
- Naming convention that mechanically derives one class name from another (e.g., Xxx -> XxxFactory, XxxSerializer,
  XxxValidator)
