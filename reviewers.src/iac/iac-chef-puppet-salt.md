...
type: primary
focus: Detect Chef, Puppet, and Salt misconfigurations including hardcoded credentials in recipes and
  manifests, missing test coverage, non-idempotent resources, incomplete metadata, and state ordering
  issues
parents:
- index.md
covers:
