...
type: primary
focus: Detect network-level TLS deployment issues in reverse proxies and load balancers including weak
  cipher suites in server config, missing OCSP stapling, certificate management gaps, and TLS termination
  at wrong layer
parents:
- index.md
aliases:
