...
type: primary
focus: Detect misconfigured or under-utilized PHP static analysis -- unjustified @phpstan-ignore annotations,
  growing baselines without review, missing strict mode progression, and unresolved mixed types
parents:
- index.md
aliases:
- lang-php
