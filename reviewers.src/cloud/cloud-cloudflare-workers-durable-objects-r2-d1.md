...
type: primary
focus: Detect Workers KV consistency misunderstanding, Durable Objects misuse, R2/D1 pitfalls, secrets
  in wrangler.toml, and CPU/subrequest limit violations
parents:
- index.md
covers:
