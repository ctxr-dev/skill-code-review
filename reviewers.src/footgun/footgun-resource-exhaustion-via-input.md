...
type: primary
focus: Detect unbounded allocation from user input -- array sizes, string lengths, zip bombs, XML bombs,
  deeply nested JSON, and large file uploads without limits
parents:
- index.md
aliases:
