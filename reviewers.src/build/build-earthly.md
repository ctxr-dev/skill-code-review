...
id: build-earthly
type: primary
focus: Detect Earthly misconfigurations including missing --push flag, secrets in Earthfile, large build
  contexts, missing cache mounts, and non-reproducible RUN commands
parents:
- index.md
covers:
