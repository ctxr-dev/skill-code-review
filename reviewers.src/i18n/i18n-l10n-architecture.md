...
type: primary
focus: Detect i18n/l10n architecture gaps -- hardcoded strings, concatenated messages, missing ICU plural
  rules, absent fallback chains, RTL/locale oversights, and unsynchronised translation catalogues
parents:
- index.md
aliases:
