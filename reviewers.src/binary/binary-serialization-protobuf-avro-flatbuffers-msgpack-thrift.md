...
type: primary
focus: Detect schema-evolution hazards in binary serialization formats -- reused field numbers, missing
  reserved markers, enum reordering, required fields added, and schema-registry integration gaps
parents:
- index.md
covers:
