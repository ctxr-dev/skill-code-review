...
type: primary
focus: Detect missing focus indicators, broken tab order, keyboard traps, custom interactive elements
  without keyboard handlers, and missing skip navigation.
parents:
- index.md
covers:
