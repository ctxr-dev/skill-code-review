...
type: primary
focus: Detect embedded / RTOS hazards -- ISR misuse, watchdog omissions, stack sizing, priority inversion,
  DMA memory placement, missing volatile, and MMIO / memory-barrier bugs
parents:
- index.md
covers:
