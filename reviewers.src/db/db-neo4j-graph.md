...
id: db-neo4j-graph
type: primary
focus: Detect Neo4j and graph database pitfalls around Cypher injection, APOC security, index usage, unbounded
  traversals, Cartesian products, and relationship direction semantics
parents:
- index.md
aliases:
- data-graph-modeling
