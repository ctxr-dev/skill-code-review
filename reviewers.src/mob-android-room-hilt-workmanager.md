...
type: primary
focus: Detect Room queries on the main thread, missing database migrations, Hilt scope mismatches, WorkManager
  constraint omissions, and missing foreground service type declarations.
parents:
- index.md
covers:
