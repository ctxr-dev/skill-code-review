...
type: primary
focus: Detect Insecure Direct Object Reference and Mass Assignment vulnerabilities where user-supplied
  identifiers access resources without ownership checks or request bodies bind directly to data models
  without field allowlists.
parents:
- index.md
covers:
