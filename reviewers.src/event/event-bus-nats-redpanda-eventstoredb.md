...
type: primary
focus: Detect persistence gaps, compatibility assumptions, missing idempotency on projections, and under-configured
  stream policies across NATS, Redpanda, and EventStoreDB
parents:
- index.md
covers:
