...
id: orm-prisma
type: primary
focus: Detect Prisma-specific pitfalls including N+1 via implicit relation loading, raw query injection,
  missing indexes in schema, migration drift, connection pool exhaustion, and transaction misuse
parents:
- index.md
covers:
