...
id: k8s-rbac
type: primary
focus: Detect overly permissive Kubernetes RBAC configurations including wildcard verbs, cluster-admin
  bindings, escalation paths, and service account misuse
parents:
- index.md
covers:
