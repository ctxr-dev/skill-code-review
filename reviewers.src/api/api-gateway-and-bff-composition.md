...
type: primary
focus: Detect API gateway and BFF anti-patterns including business logic in the gateway, missing gateway-level
  rate limiting, aggregation timeout issues, and incorrect auth delegation
parents:
- index.md
aliases:
