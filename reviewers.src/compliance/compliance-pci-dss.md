...
type: primary
focus: Detect PCI DSS v4.0 violations including cardholder data exposure in code and logs, missing encryption
  at rest and in transit, insecure key management, absent audit logging for card operations, and prohibited
  data storage
parents:
- index.md
covers:
