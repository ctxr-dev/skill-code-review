...
type: primary
focus: Detect OTel SDK misconfiguration including missing exporters, NOOP providers in production, broken
  context propagation, and missing resource attributes
parents:
- index.md
covers:
