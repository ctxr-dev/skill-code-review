...
type: primary
focus: Detect non-reversible migrations, locking DDL on large tables, data loss risks, missing backfill
  steps, and deployment ordering issues in database schema migrations
parents:
- index.md
covers:
