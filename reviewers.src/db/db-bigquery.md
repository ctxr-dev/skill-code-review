...
id: db-bigquery
type: primary
focus: Detect BigQuery pitfalls around slot usage, clustering, partitioning, wildcard tables, DML quotas,
  streaming inserts vs batch loading, and cost control
parents:
- index.md
aliases:
