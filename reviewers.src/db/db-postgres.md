...
id: db-postgres
type: primary
focus: Detect PostgreSQL-specific pitfalls around VACUUM, MVCC bloat, lock escalation, index misuse, CTE
  materialization, connection exhaustion, and missing pg_stat analysis
parents:
- index.md
covers:
