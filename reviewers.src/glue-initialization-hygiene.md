...
type: primary
focus: Detect configuration and dependency validation deferred past startup, missing fail-fast on required
  environment variables, and initialization sequences that hide broken dependencies until first request
parents:
- index.md
covers:
