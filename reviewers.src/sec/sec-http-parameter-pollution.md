...
type: primary
focus: Detect HTTP Parameter Pollution vulnerabilities where duplicate, overloaded, or inconsistently
  parsed parameters allow attackers to bypass security controls or inject unexpected values.
parents:
- index.md
covers:
