...
id: tool-rubocop
type: primary
focus: Detect misconfigured or under-utilized RuboCop setups -- unjustified rubocop:disable comments,
  outdated configs with new cops not enabled, missing performance and Rails extensions, and custom cops
  without specs
parents:
- index.md
covers:
