...
type: primary
focus: Detect Azure Functions missing managed identity, Cosmos DB partition key and RU misconfigurations,
  cold start issues, and consistency level mismatches
parents:
- index.md
covers:
