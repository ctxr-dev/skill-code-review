...
type: primary
focus: Detect container image security and hygiene issues including running as root, unpinned base images,
  missing multi-stage builds, secrets in layers, and unnecessary packages
parents:
- index.md
covers:
