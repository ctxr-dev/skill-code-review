...
id: pattern-memento
type: primary
focus: Detect misuse, over-application, and absence of the Memento pattern in state-snapshot and undo/redo
  code.
parents:
- index.md
covers:
...
- correctness
audit_surface:
- Memento class is opaque to the caretaker -- no public getters, setters, or fields expose originator
  internals
