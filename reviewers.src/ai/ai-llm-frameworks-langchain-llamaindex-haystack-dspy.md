...
type: primary
focus: Detect framework abstraction hiding errors, deprecated API usage, unhandled chain/pipeline errors,
  unbounded conversation memory, and callback handlers with side effects
parents:
- index.md
covers:
