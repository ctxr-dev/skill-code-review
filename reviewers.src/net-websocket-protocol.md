...
type: primary
focus: Detect WebSocket protocol issues including missing auth on upgrade, absent heartbeat, no reconnection
  logic, missing message size limits, and insecure ws:// usage
parents:
- index.md
aliases:
